...
v0.6.6 完成了持久化中英界面的覆盖：内置静态文案、动态状态、Agent 反馈、无障碍标签、扩展元数据和默认 AI 提示词都会随所选语言切换；同时保留 v0.6.5 对页面探测、favicon 哈希、规则状态一致性与缓存失效的加固。当前测量及各历史版本见[性能记录](BENCHMARK_CN.md)。
